...
public class UsagePixelMonitoringHandler extends AbstractMonitoringHandler
{
	protected static Logger LOGGER = Logger.getLogger(UsagePixelMonitoringHandler.class);
	...
	public boolean isResponsible(AgreementDocument pAgreement)
	{
		...
		{
			if (property.getType().startsWith(ServicePropertiesURN.USAGE_PIXEL))
			{
				return true;
			}
		}
