...
public class ResourceOperationMonitoringHandler extends AbstractMonitoringHandler
{
	protected static Logger LOGGER = Logger.getLogger(ResourceOperationMonitoringHandler.class);
	...
	public boolean isResponsible(AgreementDocument pAgreement)
	{
		...
		{
			if (property.getType().startsWith(ServicePropertiesURN.RESOURCE_OPERATION))
			{
				return true;
			}
		}
