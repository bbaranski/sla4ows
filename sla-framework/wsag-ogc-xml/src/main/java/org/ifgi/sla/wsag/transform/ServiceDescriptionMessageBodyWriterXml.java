...
@Provider
@Singleton
public class ServiceDescriptionMessageBodyWriterXml implements MessageBodyWriter<ServiceDescriptionDocument>
{
	protected static Logger LOGGER = Logger.getLogger(ServiceDescriptionMessageBodyWriterXml.class);
	 ...
	 */
	@Override
	public long getSize(ServiceDescriptionDocument arg0, Class<?> arg1, Type arg2, Annotation[] arg3, MediaType arg4)
	{
		return -1;
	}
	 ...
	 */
	@Override
	public void writeTo(ServiceDescriptionDocument t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
