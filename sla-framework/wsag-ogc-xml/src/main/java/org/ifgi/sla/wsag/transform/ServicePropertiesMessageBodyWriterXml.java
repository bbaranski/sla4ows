...
@Provider
@Singleton
public class ServicePropertiesMessageBodyWriterXml implements MessageBodyWriter<ServicePropertiesDocument>
{
	protected static Logger LOGGER = Logger.getLogger(ServicePropertiesMessageBodyWriterXml.class);
	 ...
	 */
	@Override
	public long getSize(ServicePropertiesDocument arg0, Class<?> arg1, Type arg2, Annotation[] arg3, MediaType arg4)
	{
		return -1;
	}
	 ...
	 */
	@Override
	public void writeTo(ServicePropertiesDocument t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
