...
@Provider
@Singleton
public class MeasurementListMessageBodyReaderXml implements MessageBodyReader<MeasurementListDocument>
{
	protected static Logger LOGGER = Logger.getLogger(MeasurementListMessageBodyReaderXml.class);
	...
	public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType)
	{
		...
		boolean classTypeCompatibel = type.getName().equalsIgnoreCase(MeasurementListDocument.class.getName());
	 ...
	 */
	@Override
	public MeasurementListDocument readFrom(Class<MeasurementListDocument> arg0, Type arg1, Annotation[] arg2, MediaType arg3,
			MultivaluedMap<String, String> arg4, InputStream arg5) throws IOException, WebApplicationException
	{
		try
		{
			return MeasurementListDocument.Factory.parse(arg5);
		}
