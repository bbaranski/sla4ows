...
import org.ifgi.namespaces.wsag.rest.impl.TemplateListDocumentImpl;

import com.sun.jersey.spi.resource.Singleton;

@Provider
@Singleton
public class TemplateListMessageBodyWriterXml implements MessageBodyWriter<TemplateListDocument>
{
	protected static Logger LOGGER = Logger.getLogger(TemplateListMessageBodyWriterXml.class);
	 ...
	 */
	@Override
	public long getSize(TemplateListDocument arg0, Class<?> arg1, Type arg2, Annotation[] arg3, MediaType arg4)
	{
		return -1;
	}
	...
	public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType)
	{
		...
		boolean classTypeCompatibel = type.getName().equalsIgnoreCase(TemplateListDocumentImpl.class.getName());
	 ...
	 */
	@Override
	public void writeTo(TemplateListDocument t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
