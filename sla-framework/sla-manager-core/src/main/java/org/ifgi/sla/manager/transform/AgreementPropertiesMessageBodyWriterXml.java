...
@Provider
@Singleton
public class AgreementPropertiesMessageBodyWriterXml implements MessageBodyWriter<AgreementPropertiesDocument>
{
	protected static Logger LOGGER = Logger.getLogger(AgreementPropertiesMessageBodyWriterXml.class);
	 ...
	 */
	@Override
	public long getSize(AgreementPropertiesDocument arg0, Class<?> arg1, Type arg2, Annotation[] arg3, MediaType arg4)
	{
		return -1;
	}
	 ...
	 */
	@Override
	public void writeTo(AgreementPropertiesDocument t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, Object> httpHeaders, OutputStream entityStream) throws IOException,
