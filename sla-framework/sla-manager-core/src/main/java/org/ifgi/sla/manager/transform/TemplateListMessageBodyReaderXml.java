...
@Provider
@Singleton
public class TemplateListMessageBodyReaderXml implements MessageBodyReader<TemplateListDocument>
{
	protected static Logger LOGGER = Logger.getLogger(TemplateListMessageBodyReaderXml.class);
	...
	public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType)
	{
		...
		boolean classTypeCompatibel = type.getName().equalsIgnoreCase(TemplateListDocument.class.getName());
	 ...
	 */
	@Override
	public TemplateListDocument readFrom(Class<TemplateListDocument> arg0, Type arg1, Annotation[] arg2, MediaType arg3, MultivaluedMap<String, String> arg4,
			InputStream arg5) throws IOException, WebApplicationException
	{
		try
		{
			return TemplateListDocument.Factory.parse(arg5);
		}
