...
@Provider
@Singleton
public class MeasurementHistoryListMessageBodyWriterXml implements MessageBodyWriter<MeasurementHistoryListDocument>
{
	protected static Logger LOGGER = Logger.getLogger(MeasurementHistoryListMessageBodyWriterXml.class);
	 ...
	 */
	@Override
	public long getSize(MeasurementHistoryListDocument arg0, Class<?> arg1, Type arg2, Annotation[] arg3, MediaType arg4)
	{
		return -1;
	}
	 ...
	 */
	@Override
	public void writeTo(MeasurementHistoryListDocument t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
