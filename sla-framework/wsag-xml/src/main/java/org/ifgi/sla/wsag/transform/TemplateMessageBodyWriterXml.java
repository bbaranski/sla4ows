...
import org.ggf.schemas.graap.x2007.x03.wsAgreement.impl.TemplateDocumentImpl;

import com.sun.jersey.spi.resource.Singleton;

@Provider
@Singleton
public class TemplateMessageBodyWriterXml implements MessageBodyWriter<TemplateDocument>
{
	protected static Logger LOGGER = Logger.getLogger(TemplateMessageBodyWriterXml.class);
	 ...
	 */
	@Override
	public long getSize(TemplateDocument arg0, Class<?> arg1, Type arg2, Annotation[] arg3, MediaType arg4)
	{
		return -1;
	}
	...
	public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType)
	{
		...
		boolean classTypeCompatibel = type.getName().equalsIgnoreCase(TemplateDocumentImpl.class.getName());
	 ...
	 */
	@Override
	public void writeTo(TemplateDocument t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
