...
@Provider
@Singleton
public class TemplateMessageBodyReaderXml implements MessageBodyReader<TemplateDocument>
{
	protected static Logger LOGGER = Logger.getLogger(TemplateMessageBodyReaderXml.class);
	...
	public boolean isReadable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType)
	{
		...
		boolean classTypeCompatibel = type.getName().equalsIgnoreCase(TemplateDocument.class.getName());
	 ...
	 */
	@Override
	public TemplateDocument readFrom(Class<TemplateDocument> arg0, Type arg1, Annotation[] arg2, MediaType arg3, MultivaluedMap<String, String> arg4,
			InputStream arg5) throws IOException, WebApplicationException
	{
		try
		{
			return TemplateDocument.Factory.parse(arg5);
		}
