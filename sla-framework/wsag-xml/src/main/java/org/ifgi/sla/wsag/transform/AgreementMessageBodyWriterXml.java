...
import org.ggf.schemas.graap.x2007.x03.wsAgreement.impl.AgreementDocumentImpl;

import com.sun.jersey.spi.resource.Singleton;

@Provider
@Singleton
public class AgreementMessageBodyWriterXml implements MessageBodyWriter<AgreementDocument>
{
	protected static Logger LOGGER = Logger.getLogger(AgreementMessageBodyWriterXml.class);
	 ...
	 */
	@Override
	public long getSize(AgreementDocument arg0, Class<?> arg1, Type arg2, Annotation[] arg3, MediaType arg4)
	{
		return -1;
	}
	...
	public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType)
	{
		...
		boolean classTypeCompatibel = type.getName().equalsIgnoreCase(AgreementDocumentImpl.class.getName());
	 ...
	 */
	@Override
	public void writeTo(AgreementDocument t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
